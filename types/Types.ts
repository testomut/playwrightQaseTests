...
export type ErrorMessagesType =
    'exist email' | 'invalid format' | 'small password' | 'wrong phone' | 'empty email' | 'empty organization';
export type MessageFormAlertType =
    'expire date' | 'invalid card' | 'declined card' | 'business address' | 'incomplete card' | 'incomplete date';
export type ExportFileType = 'csv' | 'txt';
export type CreditsAmount = 1000 | 2000 | 3000 | 4000 | 10000 | 20000 | 40000 | 60000 | 80000 | 100000;
export type IfBalanceFallsBelow =
    100 | 200 | 400 | 600 | 1000 | 2000 | 3000 | 4000 | 5000 | 10000 | 20000 | 30000 | 40000;
export type MessagesAmount =
    '250' | '500' | '1k' | '2.5k' | '5k' | '7.5k' | '10k+' | '3k' | '6k' | '12k' | '30k' | '60k' | '90k' | '120k+';
...
export type PlanType =
    ...
    | 'pro-yearly-60000'
    | 'pro-yearly-90000';
export type SetConditions = Array<SetCondition>;
export type ContactsList = Array<ContactInfo>;
export type MediaArray = Array<MediaType>;
export type AddedMembersList = Array<InviteMember>;
export type ActiveMembersList = Array<ActiveMember>;
export type InboxesList = Array<InboxItem>;
export type TriggerMessageTableList = Array<TriggerMessageTable>;
export type BroadcastsTableList = Array<BroadcastsTable>;
